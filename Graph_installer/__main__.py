...
def createApp (connect):
    appname = "graph" + str(time() * 1000)[-4:].replace(".", "") + str(random.randint(0,500))
    try:
...
if __name__ == "__main__":
    ...
    config['TZ'] = TZ
    config['TZ_NUMBER'] = "1"
    config['UPSTREAM_REPO_URL'] = "https://github.com/This-is-bekar/Graph--Userbot"
    config['WARN_LIMIT'] = "3"
